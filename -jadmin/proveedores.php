...
<head>
    ...
    <title data-title="3">Proveedores</title>
</head>
<body>
        ...
        <section class="containerHeader">
            <button id="btnAddProveedor">+ nuevo</button>
                ...
                <div class="containerInputSearch">
                    ...
                    <label for="inputSearch" class="labelHolder">Buscar Proveedor</label>
                </div>
        </section>
    ...
    <template id="templatePaginacion">
        <button href="#"><li></li></button>
    </template>

    <!-- -------- TEMPLATE TR FILA TABLA PROVEEDORES ---------- -->

    <template id="templateRow">
        <tr class="rowProveedor">
            <td></td>
            <td></td>
            <td></td>
            <td></td>
